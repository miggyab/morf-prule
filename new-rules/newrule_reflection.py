...
if __name__ == "__main__":
    ...
    avg_reflection = nr.get_reflection(path_to_features)
    ...
    filename = course_slug + "-" + itr + "_p2.csv"
    p2 = nr.merge(avg_reflection, grades, os.path.join(path_to_output, filename))
