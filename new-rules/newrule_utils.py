...
def print_to_output_path(p_dict, path_to_output):
    with open(path_to_output, "w+") as outfile:
        outfile.write("username,feature,achievement_level\n")
        for username in p_dict:
            outfile.write(username + "," + str(p_dict[username][0]) + "," + p_dict[username][1] + "\n")
